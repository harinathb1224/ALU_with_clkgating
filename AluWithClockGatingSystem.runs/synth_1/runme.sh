...
HD_PWD='C:/Users/chapi/.Xilinx/AluWithClockGatingSystem/AluWithClockGatingSystem.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log ALU_System_4bit_Gated.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source ALU_System_4bit_Gated.tcl
