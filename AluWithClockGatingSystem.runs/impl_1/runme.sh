...
HD_PWD='C:/Users/chapi/.Xilinx/AluWithClockGatingSystem/AluWithClockGatingSystem.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log ALU_System_4bit_Gated.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source ALU_System_4bit_Gated.tcl -notrace
